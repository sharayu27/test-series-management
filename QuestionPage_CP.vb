...
Public Class QuestionPage_CP
    Dim counter As Integer = 0
    Public qid As Integer
    Public sum_c As Integer
    Dim flag As Integer
    Dim flag1 As String
    ...
    Private Sub Button2_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Next_Button.Click
        ...
        Using mongo.RequestStart(db)
            ...
            Dim collection = db.GetCollection("CP_ques")
    ...
    Private Sub Button3_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save_Button.Click
        ...
        mongo.Connect()
        Dim db = mongo.GetDatabase("AptitudeMock")
        Dim collection = db.GetCollection(Of BsonDocument)("Check_result_CP")
        Dim ans As String
    ...
    Private Sub Pre_Button_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Pre_Button.Click
        ...
        Using mongo.RequestStart(db)
            ...
            Dim collection = db.GetCollection(Of BsonDocument)("CP_ques")
    ...
    Private Sub QuestionPage_CP_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        If (Next_Button.Enabled = False) Then
            Next_Button.Enabled = True
        End If
